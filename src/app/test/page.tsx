...
export const metadata: Metadata = {
  title: "Test What Your API Endpoint Actually Delivers · APISpotlight",
  description: "在浏览器中直接测试你有权使用的 API Endpoint 实际返回了什么。",
  alternates: {
    canonical: "/test/",
  },
  openGraph: {
...
export default function TestPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:py-12">
      <h1 className="text-3xl font-bold">🧪 Test What Your API Endpoint Actually Delivers</h1>
